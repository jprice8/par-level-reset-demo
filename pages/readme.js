    ...
    <AltNavBar>
      <div className="max-w-3xl mx-auto flex flex-col h-screen justify-between pb-20">
        <div className="mt-20 bg-white p-4 shadow-md rounded-md space-y-4">
          ...
          <p>
            The web app you are using is a demonstration of a production tool
            that was used by a health system&apos;s supply chain team in 2021. I
            built this demo app to serve as a point of reference and to help
          ...
          <p>
            ...
            historical demand has shown. You are emailed that there are five
            new items for you to review and reset. You then follow the link on
            the email to this site where you can start resetting your inventory
          ...
          <p>
            ...
            saved using a PostgreSQL cluster which is managed by AWS. The frontend
            client is very similiar to the demo app you are using right now. It
            is a SPA using the React library with state management using Redux.
            To help simplify the demo app, it is disconnected from a backend and is
            maintaining all data within the client using Redux. Simply refresh the
            browser to start over. 
          </p>
